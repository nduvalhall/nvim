...
" Language keywords
syntax keyword porthKeywords if if* else while do include memory proc const end offset reset assert in inline here addr-of call-like let peek return var cast
